	...
	<div class="container-fluid" style="border-bottom: 2px solid #ff6a00;">
		<div class="row align-items-center">
			<div data-aos="fade-down">
				<img src="resources/Baby/baby.jpg" alt="img" class="img"
					style="width: 50px; height: 50px;">
			</div>
			<div class="col-offset-3 col-xl-offset-3" data-aos="fade-down">
				<h1 class="mb-0">
					<a href="index.kosmo" class="text-black h2 mb-0">육아육아해</a>
				</h1>
			</div>
					...
					<ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
						...
						<li class="has-children active"><a href="#">마이페이지</a>
							<ul class="dropdown">
								...
								<li><a href="mypage_two.kosmo">Menu Two</a></li>
							</ul></li>
