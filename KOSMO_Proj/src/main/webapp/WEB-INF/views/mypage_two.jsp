				...
				<div class="writeType1">
							...
							<div class="right">
								<div class="radioBox">
									<label for="gender1">&nbsp;남성 <input type="radio"
										id="gender1" name="SEX_C" value="M" style="display: inline"></label>
								</div>
								<div class="radioBox">
									<label for="gender2">&nbsp;여성 <input type="radio"
										id="gender2" name="SEX_C" value="F" style="display: inline"></label>
								</div>
							</div>
						</li>
							...
							<div class="right inputArea">
								<div class="mailInput">
									...
									<div class="input-area type2" style="width: 120px">
										<input type="text" id="emailId" name="EMAIL_ID" value=""
											placeholder="이메일 입력">
									</div>
						...
						<li>
							...
							<div class="right inputArea">
								...
								<div class="input-area mt5">
									<input type="text" id="bscAdr" name="OHSE_BSC_ADR"
										value="유저의 기존 주소" style="font-size: 11px; width: 100%;"
										placeholder="주소">
								</div>
								<div class="input-area mt5">
					...
					<div class="btnBox taC mt10" style="margin-bottom: 100px;">
						<button type="button" class="btn btn-info"
							style="background-color: gray; border-color: gray;">이전
							항목으로</button>
